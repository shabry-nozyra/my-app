            ...
            <Container fluid className="mt-3 px-5">
                <div className="row">
                    <div className="col-md-9 px-3 pt-0">
                        ...
                        <h3 className="text-danger juduljudul">{"Kecamatan {nama_kecamatan}"}</h3>
                            ...
                            <div className="col-md-4 p-2">
                                <div className="card">
                                    <div className="card-header bg-danger p-2">
                                        <div className="row">
                                            <div className="col-3">
                                                <p className="mb-0 text-white">TPS {"{no}"}</p>
                                            </div>
                                            <div className="col-9">
                                                ...
                                                <div className="card mb-3">
                                                    <div className="row no-gutters">
                                                        ...
                                                        <div className="col-md-6 d-flex justify-content-center align-items-center p-2">
                                                            <h2 className="card-title">{"{persen}"}</h2>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div className="card-footer text-muted">
                                        <div className="row d-flex justify-content-between">
                                            <div className="col-8">
                                                <footer className="blockquote-footer">Jumlah Pemilih Tetap : {"{jpt}"}</footer>
                                            </div>
                                            <div className="col-4">
